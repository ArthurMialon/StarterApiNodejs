...
module.exports = {
  ...
  /**
  * Here your can configure your routes, this is a simple JSOM format
  ...
  * You can specify a controller where you action is define --> in api/controllers directory
  ...
  * You can specify what the user should have to be able to call the route ex : administrator
  **/

...
var Requester = {
  ...
  * Allow router method
  */
  allowMethod: ['get', 'post', 'put', 'delete', 'patch', 'options'],
  ...
  */
  ...
  /**
  * Create a new route
  * @param {object} Object Express router object
  * @param {object}   String route path
  * @param {object}  Object route infos (method, action, controller etc...)
  * @param {object}     Object Socket.io object
  */
  ...
  */
  ...
  /**
  * Init socket
  * @param {boolean} route socket infos
  * @return {boolean}
  */
  ...
  */
  initMiddleware: function(middleware, auth) {
    ...
    if (middleware) {
      ...
      middleware = [];
      for (var m in this.defaults.middleware) {
  ...
  * @param {String} action
  * @return {object} null || controller object
  */
